...
An access token is valid for 2 day. You can modify this expiration time by changing the `expiresIn` property .
...
A refresh token is valid for 7 days. You can modify this expiration time by changing the `expiresIn` property.
